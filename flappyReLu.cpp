//ไฟล์นี้เป็นการเพิ่มระบบ deep q-network แบบง่ายๆ เข้ามาในเกม Flappy Bird ที่เราเคยทำกันไว้ก่อนหน้านี้ โดยผมปรับโครงสร้างสมองขึ้นเป็น 64 และใช้ ReLU เป็นฟังก์ชันกระตุ้น เพื่อให้ AI สามารถเรียนรู้และปรับตัวได้ดีขึ้นในการเล่นเกมนี้
